              ...
              return `
                <div class="budget-visual__item" data-entry-id="${this.escapeHtml(entry.id)}">
                  <div class="budget-visual__info">
                    ...
                    <button type="button" class="budget-visual__icon" data-action="edit" data-entry-id="${this.escapeHtml(entry.id)}" aria-label="Изменить статью">
                      <span aria-hidden="true">✏️</span>
                    </button>
                    <button type="button" class="budget-visual__icon budget-visual__icon--danger" data-action="delete" data-entry-id="${this.escapeHtml(entry.id)}" aria-label="Удалить статью">
                      <span aria-hidden="true">🗑️</span>
                    </button>
                  </div>
