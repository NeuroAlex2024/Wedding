...
const DEFAULT_CHECKLIST_ITEMS = [
  { id: "task-1", type: "task", title: "Выбрать дату и площадку", done: false, folderId: null },
  { id: "task-2", type: "task", title: "Согласовать бюджет с партнёром", done: false, folderId: null },
  { id: "task-3", type: "task", title: "Составить список гостей", done: false, folderId: null }
];
